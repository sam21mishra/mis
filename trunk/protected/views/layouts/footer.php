...
<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/plugins/jeditable/jquery.jeditable.js"></script>
<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/plugins/dataTables/datatables.min.js"></script>
...
<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/core.js"></script>
